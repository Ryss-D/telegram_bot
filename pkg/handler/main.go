// Package handler contains an HTTP Cloud function to handle update from  Telegram
package main
...
// Define a few constants and variable to handle diferent commands
...
var lenStartCommand inst = len(startCommand)

const botTag string = "@RapGeniusBot"

var lenBotTag int = len(botTag)

// Pass token and sensible APIs trough enviroment variables
